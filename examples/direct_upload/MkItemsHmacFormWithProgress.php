<?php
# Sample to demonstrate how to generate a basic form with a progress bar (requires jquery.uploadProgress.js) that allows end users to upload a file directly to Clevercast
# This is done using the Clevercast 'items-hmac-redirect' resource, which uses HMAC authentication.
#
...
# required variables
$account_id = "xxxxxxx";                              # id of your Clevercast account
...
$html = <<<EOT
  ...
  <head>
	<title>Clevercast API - upload with form using the 'items-hmac-redirect' endpoint</title>
