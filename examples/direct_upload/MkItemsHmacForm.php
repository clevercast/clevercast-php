<?php
# Sample to demonstrate how to generate a basic form that allows end users to upload a file directly to Clevercast
...
# required variables
$account_id = "xxxxxxxx";                           # id of your Clevercast account
